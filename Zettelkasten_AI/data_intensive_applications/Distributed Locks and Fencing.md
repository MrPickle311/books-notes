...
![Figure 9-4: Incorrect implementation of a distributed lock: client 1 believes that it still has a valid lease, even though it has expired, and thus corrupts a file in storage.](data_intensive_applications/figure-9-4.png)
...
![Figure 9-5: A message from a former leaseholder might be delayed for a long time, and arrive after another node has taken over the lease.](data_intensive_applications/figure-9-5.png)
...
![Figure 9-6: Making access to storage safe by allowing writes only in the order of increasing fencing tokens.](data_intensive_applications/figure-9-6.png)
...
![Figure 9-7: Using fencing tokens to protect writes to a leaderless replicated database.](data_intensive_applications/figure-9-7.png)
